...
(function () {
  ...
  const MENU = {
    ...
    pizza: [
      { n: "Margherita", d: "Tomate, mozzarella, basilic frais", p: "11€" },
      { n: "Reine", d: "Tomate, mozzarella, jambon, champignons", p: "13€" },
      { n: "3 Fromages", d: "Mozzarella, chèvre, gorgonzola, parmesan", p: "14€" },
      { n: "Orientale", d: "Tomate, mozzarella, merguez, poivrons, oignons", p: "14€", b: "Hallal" },
      { n: "Diavola", d: "Tomate, mozzarella, chorizo piquant", p: "13€" },
      { n: "Montagnarde", d: "Crème, mozzarella, lardons, pommes de terre, reblochon", p: "14€" },
      { n: "All Pollo", d: "Tomate, mozzarella, poulet, oignons rouges", p: "14€", b: "Hallal" },
      { n: "Méridionale", d: "Tomate, mozzarella, aubergines, courgettes, poivrons grillés", p: "13€" },
      { n: "Raffinée", d: "Crème, mozzarella, saumon fumé, roquette, citron", p: "15€" },
    ],
  };
