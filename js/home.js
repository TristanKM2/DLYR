...
(function () {
  ...
  const GAMES = [
    { name: 'Outbreak Lab', genre: 'Aventure', theme: 'Survie · Zombies', pitch: "Un laboratoire contaminé, des couloirs plongés dans le noir et une horde qui se rapproche : survivrez-vous assez longtemps pour percer le secret de X-Labs ?", dur: '30 min', pl: '2 à 12 joueurs', img: 'uploads/experiences/Outbreak Lab 3-4.png', href: 'jeu-outbreak-lab.html' },
    { name: 'Titanic — Le Rêve Englouti', genre: 'Culturel', theme: 'Histoire · Exploration', pitch: "Explorer le Titanic, percer ses mystères et revivre son voyage inaugural.", dur: '30 min', pl: '1 à 12 joueurs', img: 'uploads/experiences/Titanic sans titre.png', href: 'jeu-titanic-le-reve-englouti.html' },
    { name: 'Volcanic Warfare', genre: 'Action', theme: 'Team Deathmatch · Tactique', pitch: "La lave dévale l'île et le sol tremble sous vos pieds. Deux équipes s'affrontent, une seule victoire : jouez serré, la montagne ne pardonne pas.", dur: '30 min', pl: '4 à 8 joueurs', img: 'uploads/experiences/Volcanic Warfare sans titre.png', href: 'jeu-volcanic-warfare.html' },
    { name: 'Versailles — Les Jardins Disparus du Roi Soleil', genre: 'Culturel', theme: 'Histoire · Exploration', pitch: "Explorer les jardins disparus et découvrir les trésors cachés de Versailles.", dur: '30 min', pl: '1 à 12 joueurs', img: 'uploads/experiences/Vesailles sans titre.png', href: 'jeu-versailles-les-jardins-disparus-du-roi-soleil.html' },
    { name: 'Paradise Expedition', genre: 'Action', theme: 'Free For All · Survie', pitch: "Une serre tropicale magnifique… et impitoyable. Chacun pour soi : dans ce paradis perdu, chaque rencontre peut être votre dernière.", dur: '30 min', pl: '2 à 12 joueurs', img: 'uploads/experiences/Paradise Expedition sans Titre.png', href: 'jeu-paradise-expedition.html' },
    { name: 'Quantum Dome Project — Le Louvre Abu Dhabi', genre: 'Culturel', theme: 'Aventure · Histoire', pitch: "Embarquez pour une aventure extraordinaire à travers les âges. Explorez la Rome impériale, la Maison de la Sagesse de Bagdad et l'Inde moghole.", dur: '30 min', pl: '1 à 12 joueurs', img: 'uploads/experiences/Quantum Dome sans titre.png', href: 'jeu-quantum-dome-project.html' },
    { name: 'Harbor Siege', genre: 'Action', theme: 'Conquête · Stratégie', pitch: "Deux équipes, un port abandonné, des ruelles à prendre mètre par mètre. Coordonnez-vous, tenez vos positions et dominez le champ de bataille.", dur: '30 min', pl: '2 à 12 joueurs', img: 'uploads/experiences/Harbor Siege sans titre.png', href: 'jeu-harbor-siege.html' },
    { name: 'Gaudí — L\'Atelier du Divin', genre: 'Culturel', theme: 'Art · Architecture', pitch: "Comprendre Gaudí, plonger dans son atelier et reprendre son œuvre : la Sagrada Familia.", dur: '30 min', pl: '1 à 12 joueurs', img: 'uploads/experiences/Gaudi sans titre.png', href: 'jeu-gaudi-latelier-du-divin.html' },
  ];
  function posters() {
