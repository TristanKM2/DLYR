...
(function () {
  ...
  const GAMES = [
    ...
    { name: 'Titanic — Le Rêve Englouti', genre: 'Aventure', theme: 'Histoire · Exploration', pitch: "Explorer le Titanic, percer ses mystères et revivre son voyage inaugural.", dur: '30 min', pl: '2 à 12 joueurs', img: 'uploads/experiences/Titanic sans titre.png', href: 'jeu-titanic-le-reve-englouti.html' },
    ...
    { name: 'Gaudí — L\'Atelier du Divin', genre: 'Culturel', theme: 'Art · Architecture', pitch: "Comprendre Gaudí, plonger dans son atelier et reprendre son œuvre : la Sagrada Familia.", dur: '30 min', pl: '2 à 12 joueurs', img: 'uploads/experiences/Gaudi sans titre.png', href: 'jeu-gaudi-latelier-du-divin.html' },
  ];
  function posters() {
