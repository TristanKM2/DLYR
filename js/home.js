...
(function () {
  ...
  const GAMES = [
    { name: 'Outbreak Lab', genre: 'Aventure', theme: 'Survie · Zombies', pitch: "Un laboratoire contaminé, des couloirs plongés dans le noir et une horde qui se rapproche : survivrez-vous assez longtemps pour percer le secret de X-Labs ?", dur: '30 min', pl: '2 à 12 joueurs', img: 'uploads/outbreak-lab.jpg', href: 'jeu-outbreak-lab.html' },
    ...
    { name: 'Quantum Dome Project — Le Louvre Abu Dhabi', genre: 'Culturel', theme: 'Aventure · Histoire', pitch: "Embarquez pour une aventure extraordinaire à travers les âges. Explorez la Rome impériale, la Maison de la Sagesse de Bagdad et l'Inde moghole.", dur: '30 min', pl: '2 à 20 participants', img: 'uploads/time-quest.jpg', href: 'jeu-quantum-dome-project.html' },
    { name: 'Snow Village', genre: 'Adapté aux enfants', theme: 'Coopératif · Magie de Noël', pitch: "Le village du Père Noël est attaqué et la magie s'éteint. En famille, défendez les lutins et rendez Noël à Snow Village.", dur: '30 min', pl: '2 à 12 joueurs', img: 'uploads/snow-village.jpg', href: 'jeu-snow-village.html' },
