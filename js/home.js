...
(function () {
  ...
  const GAMES = [
    ...
    { name: 'Titanic — Le Rêve Englouti', genre: 'Culturel', theme: 'Histoire · Exploration', pitch: "Explorer le Titanic, percer ses mystères et revivre son voyage inaugural.", dur: '30 min', pl: '2 à 12 joueurs', img: 'uploads/experiences/Titanic sans titre.png', href: 'jeu-titanic-le-reve-englouti.html' },
