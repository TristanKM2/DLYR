...
(function () {
  const FAQ = [
    ...
    { cat: 'activites', q: "Quelles sont les autres activités disponibles ?", a: "En plus de la VR, D'LYR est un véritable hub de loisirs. Nous disposons de box de karaoké privés pour libérer votre voix et de pistes de fléchettes connectées pour défier vos amis." },
    ...
    { cat: 'activites', q: "Les box de karaoké sont-ils privatifs ?", a: "Oui, chaque box de karaoké est entièrement privatif. Vous profitez d'un catalogue de plusieurs milliers de titres, d'un éclairage d'ambiance et d'un service de boissons directement en cabine." },
  ...
  const CATS = { all: 'Toutes les questions', vr: 'VR Freeroaming', food: 'Food & Drinks', activites: 'Karaoké & Fléchettes', pro: 'Évènements Pro' };
  const PER = 6;
