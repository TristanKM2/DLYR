...
(function () {
  const FAQ = [
    { cat: 'vr', q: "Qu'est-ce que la réalité virtuelle en déplacement libre (Free-Roaming) ?", a: "Chez D'LYR, vous n'êtes pas statique, ni dans un box, relié à un fil ou avec un sac à dos. Grâce à notre technologie de pointe et nos grandes arènes, vous êtes équipé d'un casque VR autonome de dernière génération et vous vous déplacez réellement et librement sur notre plateau de jeu. Vos mouvements physiques sont instantanément reproduits dans le monde virtuel." },
    { cat: 'vr', q: "À partir de quel âge peut-on jouer ?", a: "Nos expériences sont accessibles à partir de 8 ans. Cette limite est liée à la taille des casques VR pour garantir un confort visuel optimal, ainsi qu'au contenu de nos catalogues de jeux. Les mineurs doivent être accompagnés d'un adulte. L'adulte peut être simple accompagnateur." },
    ...
    { cat: 'pratique', q: "Les mineurs peuvent-ils venir non accompagnés ?", a: "En raison de notre licence de débit de boissons (licence 3), la réglementation impose que les mineurs de moins de 16 ans soient obligatoirement accompagnés d'un adulte majeur (parents ou responsable légal) pour accéder à notre établissement. Merci de votre compréhension." },
